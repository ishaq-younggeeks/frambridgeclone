          ...
          <defs>
            ...
            >
              <image
                ...
                xlinkHref={croppedImage?croppedImage:`${process.env.PUBLIC_URL}/r.jpg`}
              ></image>
            </pattern>
            <linearGradient
            ...
            <g>
              ...
              <g className="moulding">
                ...
                <path
                  ...
                  transform={`rotate(180, ${5.375+(artDimensionList[artDimension].width-3)*0.5}, ${5.375+(artDimensionList[artDimension].height-3)*0.5}) translate(0, 0)`}
                ></path>
              </g>
            </g>
          </g>
